...
package com.lixin.qiaoqixinyuan.wheel.wheelview;
...
import com.lixin.qiaoqixinyuan.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xFFFFF,
			0xCCCCCC, 0x999999};//浅灰，灰，浅黑
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.bg_gray2));
		// 设置线宽
