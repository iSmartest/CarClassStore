...
import com.lixin.qiaoqixinyuan.app.Im.ConversationListUICustomSample;
...
public class MyApplication extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        ImageLoaderUtil.configImageLoader(CONTEXT);// 配置ImageLoader
        Config.REDIRECT_URL = "http://sns.whalecloud.com/sina2/callback";
        PlatformConfig.setWeixin("wx967daebe835fbeac", "5bb696d9ccd75a38c8a0bfe0675559b3");
        PlatformConfig.setSinaWeibo("3921700954", "04b48b094faeb16683c32669824ebdad");
        PlatformConfig.setQQZone("100424468", "c7394704798a158208a74ab60104f0ba");
        LogUtil.E = true;// log输出管理
        LogUtil.D = true;
        LogUtil.I = true;
...
/*阿里即时通讯*/
        ...
        YWAPI.init(this, YWSDKUtil.APP_KEY);
    }
    ...
    public static class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            SharedPreferencesUtil.putSharePre(CONTEXT,"lat",lat);
            sb.append("\nlontitude : ");
            sb.append(location.getLongitude());    //获取经度信息
            lon=location.getLongitude()+"";
            SharedPreferencesUtil.putSharePre(CONTEXT,"lon",lon);
            sb.append("\nradius : ");
    ...
    public static boolean isLoginToa() {
        ...
        if (b) {
            ...
            ToastUtil.showToast(CONTEXT,"用户未登录，请先登录");
            return false;
        }
    }
