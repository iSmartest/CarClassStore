...
public class MyOrderCompleteAdapter extends BaseAdapter {
    ...
    public MyOrderCompleteAdapter(Context context, List<MyorderBean.OrderBean> ordersList, Dialog dialog) {
        super();
     ...
     * @param uid
     */
    private void deleteendorder(String orderNum, String uid) {
        Map<String, String> params = new HashMap<>();
        String json = "{\"cmd\":\"deleteendorder\",\"orderNum\":\"" + orderNum + "\"," +
                "\"uid\":\"" + uid + "\",\"token\":\"" + token + "\"}";
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if ("1".equals(result)) {
                                ...
                                ToastUtil.showToast(context, "删除已完成订单成功");
                            }
