...
public class AlipayCasherActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void submit() {
        ...
        if (TextUtils.isEmpty(zhanghu)) {
            ToastUtil.showToast(context,"请输入支付宝账户");
            return;
        }
        ...
        getMoneyTopay(MyApplication.getuId(),money,zhanghu,name);
    }
    /**
     * @param uid
     * @param money
     ...
     * @param realName
     */
    private void getMoneyTopay(String uid, String money, final String cardNum, String realName) {
        Map<String, String> params = new HashMap<>();
       /* params.put("cmd", "getMoneyTopay");
        params.put("uid", uid);
        params.put("money", money);
        params.put("cardNum", cardNum);
        params.put("realName", realName);*/
        String json="{\"cmd\":\"getMoneyTopay\",\"uid\":\"" + uid + "\",\"money\":\"" + money + "\"," +
