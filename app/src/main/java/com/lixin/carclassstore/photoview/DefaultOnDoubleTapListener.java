 ...
 * <p>&nbsp;</p>
 * To be used via {@link  com.lixin.carclassstore.photoview.PhotoViewAttacher#setOnDoubleTapListener(GestureDetector.OnDoubleTapListener)}
 */
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        if (null != photoViewAttacher.getOnSingleClickListener()) {
            photoViewAttacher.getOnSingleClickListener().onClick(imageView);
        }
        return false;
    }
