        ...
        AbsListView.OnScrollListener
{
    ...
    class InternalListView extends StickyListHeadersListView implements EmptyViewMethodAccessor
    {
    ...
    public PullToRefreshStickyListHeadersListView(Context context, int mode)
    {
        super(context, mode);
    }
    ...
    {
    	StickyListHeadersListView listView = new InternalListView(context, attrs);
