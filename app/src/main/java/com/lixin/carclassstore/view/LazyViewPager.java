...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    public void computeScroll() {
        ...
        // Done with scroll, clean ic_up state.
        completeScroll();
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                 ...
                 * whether the user has moved far enough from his original ic_down touch.
                 */

                /*
                * Locally do absolute value. mLastMotionY is set to the y value
                * of the ic_down event.
                */
                final int activePointerId = mActivePointerId;
                if (activePointerId == INVALID_POINTER) {
                    // If we don't have a valid id, the touch ic_down wasn't on content.
                    break;
                }
            ...
            case MotionEvent.ACTION_DOWN: {
                /*
                 * Remember location of ic_down touch.
