...
import com.lixin.carclassstore.fragment.IsCompleteFragment;
import com.lixin.carclassstore.fragment.MyAllOrderFragment;
import com.lixin.carclassstore.fragment.WaitEvaluateFragment;
import com.lixin.carclassstore.fragment.WaitGoodsFragment;
import com.lixin.carclassstore.fragment.WaitPaymentFragment;
import com.lixin.carclassstore.view.LazyViewPager;
...
public class MyAllOrderActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView imageView,imageView1,imageView2,imageView3,imageView4;// 动画图片
    private TextView tv_all_order, tv_wait_payment, tv_wait_goods,tv_wait_evaluate,tv_is_complete;// 选项名称
    ...
    private void InitViewPager(int temp) {
        ...
        fragments.add(new IsCompleteFragment());
        ...
        tv_wait_evaluate.setOnClickListener(new MyOnClickListener(3));
        tv_is_complete.setOnClickListener(new MyOnClickListener(4));
