...
public class ImageManager {
    ...
    public static void init() {
        ...
        options3 = new DisplayImageOptions.Builder()
                ...
                .showImageOnFail(R.drawable.image_fail_empty).cacheInMemory(true)
                .cacheOnDisc(true).build();
        headOpions = new DisplayImageOptions.Builder().showStubImage(R.drawable.head_img_default)
                .showImageForEmptyUri(R.drawable.head_img_default)
                .showImageOnFail(R.drawable.head_img_default).cacheInMemory(true)
                .cacheOnDisc(true).build();
