...
import com.xfb.user.custom.view.pulltofresh.library.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshSwipeListView extends
	...
	public void setInterceptView(View interceptView) {
		PullToRefreshSwipeListView.this.interceptView = interceptView;
	}
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshSwipeListView.this, deltaX,
