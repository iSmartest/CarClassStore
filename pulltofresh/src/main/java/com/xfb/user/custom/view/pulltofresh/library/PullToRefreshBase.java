 ...
 *******************************************************************************/
package com.xfb.user.custom.view.pulltofresh.library;

import com.example.pulltofresh.R;
import com.xfb.user.custom.view.pulltofresh.library.internal.FlipLoadingLayout;
import com.xfb.user.custom.view.pulltofresh.library.internal.LoadingLayout;
import com.xfb.user.custom.view.pulltofresh.library.internal.RotateLoadingLayout;
import com.xfb.user.custom.view.pulltofresh.library.internal.Utils;
import com.xfb.user.custom.view.pulltofresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		if (DEBUG) {
			// Log.d(LOG_TAG, String.format("onSizeChanged. W: %d, H: %d", w,
			// h));
		}
	...
	protected final void refreshLoadingViewsSize() {
		...
		if (DEBUG) {
			// Log.d(LOG_TAG,
			// String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d",
