 ...
 *******************************************************************************/
package com.xfb.user.custom.view.pulltofresh.library.internal;

import com.example.pulltofresh.R;
import com.xfb.user.custom.view.pulltofresh.library.ILoadingLayout;
import com.xfb.user.custom.view.pulltofresh.library.PullToRefreshBase.Mode;
import com.xfb.user.custom.view.pulltofresh.library.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public void startNightMode() {
		setTextColor(getContext().getResources().getColorStateList(
				R.color.bv_ptr_top_text_night));
		setBackgroundResource(R.color.bv_ptr_top_bg_night);
	}

	public void startDayMode() {
		setTextColor(getContext().getResources().getColorStateList(
				R.color.bv_ptr_top_text));
		setBackgroundResource(R.color.bv_ptr_top_bg);
	}
}
